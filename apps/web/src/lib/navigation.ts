...
export const mainNavItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Year-to-Date", href: "/payroll/ytd", icon: Wallet },
      { title: "Statutory Exports", href: "/payroll/statutory", icon: Wallet },
      { title: "Tax Settings", href: "/payroll/tax-settings", icon: Wallet },
